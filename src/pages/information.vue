...
<v-card max-width="1000px" class="mx-auto">
    ...
    <v-card-text class="title font-weight-regular">
        ...
        <p></p>
        Die Stellenangebote, die die Helfer:in sieht, werden entsprechend der eingestellten Suchfilter im eigenen Profil angezeigt, d.h. z.B. Zeitpunkt, Dauer, Ort. Außerdem werden die Stellen auch anhand einer Deutschlandkarte regional zugeordnet, was eine schnelle Übersicht über die in Frage kommenden Bauernhöfe ermöglicht.
        <p></p>
        Die Plattform soll dazu dienen <strong>kurzfristig regionale Ernteretter:innen an Landwirt:innen zu vermitteln</strong> und somit dazu beizutragen, den Ernteausfall so gering wie möglich zu halten.
    </v-card-text>
    <v-card-title class="display-1">
        Inspiration
    ...
    <v-card-text class="title font-weight-regular">
        ...
        <ul>
            <li>bereits <strong>gewachsenes Obst und Gemüse</strong> auf den Feldern nicht geerntet, und wahrscheinlich verrotten wird</li>
            <li>bereits vorbestellte Jungpflanzen und Setzlinge in den nächsten Wochen nicht gepflanzt werden können</li>
        </ul>
        Einerseits führt diese Situation zu einem <strong>wirtschaftlichen Schaden der Landwirt:innen</strong>. Hinzu kommt, dass wertvolle Produkte nicht geerntet werden können und somit verschwendet werden. Daraus kann es auch zu Lieferengpässen bei Obst und Gemüse in Deutschland kommen. Auch unter dem Aspekt der Nachhaltigkeit und Verschwendung von bereits eingesetzten Ressourcen besteht hier Handlungsbedarf.
        <p></p>
